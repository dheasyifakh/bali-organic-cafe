...
const menuItems: MenuItem[] = [
  { name: "Avocado Smoothie", price: "35K", desc: "Creamy blend of organic avocado & honey." },
  { name: "Vegan Buddha Bowl", price: "55K", desc: "Rice, chickpeas, fresh veggies & tahini." },
  { name: "Organic Coffee", price: "25K", desc: "Locally roasted beans brewed with love." },
  { name: "Quinoa Salad", price: "45K", desc: "Nutritious mix of quinoa, greens & citrus." },
];
